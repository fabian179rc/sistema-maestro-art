      ...
      >
        <div className="bg-brand-card border border-brand-border rounded-3xl shadow-2xl shadow-black/30 p-7 md:p-8 text-center">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="flex items-center justify-center gap-2 md:gap-3 w-full bg-brand-teal hover:bg-[#00ffcc] text-brand-dark font-black uppercase tracking-tight md:tracking-widest text-sm md:text-lg px-4 py-3.5 md:px-6 md:py-5 rounded-xl shadow-[0_0_30px_#00d4aa33] transition-all mb-6 whitespace-nowrap"
          >
